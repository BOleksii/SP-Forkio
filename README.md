...
```
cd existing_repo
git remote add origin https://gitlab.com/innamatros/sp-forkio.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/innamatros/sp-forkio/-/settings/integrations)
